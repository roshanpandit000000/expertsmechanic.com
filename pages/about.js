  ...
  return (
    <>
      <Layout title="About us">
        <div className="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4 mt-16 sm:mt-16 lg:mt-0">
          ...
          <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
            <div className="w-full lg:w-6/12">
              <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">
               <span className="text-sky-700">Expert</span> <span className="text-gray-800">Mechanic</span>  is India’s only full service auto collision
                repair chain.
              </h2>
              <p className="font-normal text-base leading-6 text-gray-600 mt-6">
                We own a full car body shop chain that is completely transparent
                and strives to provide the best service possible. We’re growing
                quickly in Northern India, and we’ll be coming soon to Western
                and Southern India.
              </p>
              <p className="font-semibold text-base leading-6 text-gray-900 mt-6">
                We believe in going above and beyond for our customers.
              </p>
              <p className="font-normal text-base leading-6 text-gray-600 mt-2">
                Our automotive shop approaches every car as a work of art that
                deserves the love and detail it needs. We believe in repairing
                the issues with your car and helping you by servicing, washing,
                fueling up or jumping a dead battery. We work hard to earn your
                trust every step of the way, whether you’re ready for us to
                start or not. We want our service to be hassle-free and provide
                lasting peace of mind with a nationwide warranty.
              </p>
            </div>
            <div className="w-full lg:w-6/12">
              <img
          ...
          <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
            <div>
              ...
              <p className="font-normal text-base leading-6 text-gray-600 mt-6">
              quality services generally refer to the maintenance and repair services provided by authorized dealerships or specialized auto repair shops.
              </p>
            </div>
            <div>
              <p className="font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 text-gray-800 mt-6">
              ...
              <p className="font-normal text-base leading-6 text-gray-600 mt-6">
              Low prices refer to the pricing strategy used by businesses to offer products or services at a lower cost than their competitors.
              </p>
            </div>
            <div className="sm:block hidden">
              ...
              <p className="font-normal text-base leading-6 text-gray-600 mt-6">
               original equipment manufacturer (OEM) parts that are designed and produced by the same manufacturer as the original parts used in a vehicle or product.
              </p>
            </div>
          </div>
          ...
          <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
            <div className="w-full lg:w-6/12">
              ...
              Car problems in Delhi
              </h2>
              <p className="font-semibold text-xl leading-6 text-gray-800 mt-6 w-full lg:w-10/12 xl:w-9/12">
              Why choose your car service in Delhi?
              </p>
              <p className="font-normal text-base leading-6 text-gray-600 mt-4 w-full lg:w-10/12 xl:w-9/12">
              In Delhi, many models from different car brands like Mahindra, Hyundai, Maruti Suzuki, and Volvo are serviced at top-quality service centers. Mechanics have top-quality tools to work with and know how to handle each model.
              </p>
              <p className="font-semibold text-xl leading-6 text-gray-800 mt-6 w-full lg:w-10/12 xl:w-9/12">
              The most common car problems in Delhi
              </p>
              <p className="font-normal text-base leading-6 text-gray-600 w-full lg:w-10/12 xl:w-9/12 mt-4">
              Delhi is a city that experiences the worst of both summers and winters every year. There are certain parts and peripherals for a car that need to be checked and maintained in order to survive these extreme situations. One of these major problems is air-conditioning, which can only be defeated by an efficient car air conditioner. Following this are the terrible road conditions in many remote areas of the city, leading to many automotive damages such as wheel alignment issues, brake related problems, and overall deterioration of your car. ExpertsMechanic is exactly what Delhiites need to find relief from their worries and we offer it quickly! ExpertsMechanic workshops are located in Vasant Kunj, Mayur Vihar, Dwarka, Chattarpur, Karol Bagh, Rohini, Greater Kailash, Cannaught Place, Vikas Puri, Hauz Khaz…
              </p>
            </div>
            <div className="w-full lg:w-6/12">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
                ...
                <div className="flex p-4 shadow-md">
                  ...
                  <div className="">
                    ...
                    We’ll keep you in the loop and update you with every step of the process.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex p-4 shadow-md">
                  ...
                  <div className="">
                    ...
                    <p className="mt-2 font-normal text-base leading-6 text-gray-600">
                    Once our team fully assesses the damage, we’ll provide an estimated completion date. Our goal is to do everything in our power to meet that projected date or even beat it if possible.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex p-4 shadow-md">
                  ...
                  <div className="">
                    ...
                    <p className="mt-2 font-normal text-base leading-6 text-gray-600">
                    If there’s a delay in your project, you’ll always be able to reach us by phone, text or email. The important thing is that we’re easy to talk to and we’ll keep you updated every step of the way.
                    </p>
                  </div>
                </div>
              </div>
